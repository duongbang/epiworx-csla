...
namespace Epiworx.Wp7.Helpers
{
    ...
    public static class CryptoHelper
    {
        ...
        public static byte[] GetHash(byte[] input)
        {
            ...
            {
                CryptoHelper.GetHashBlock(input, ref abcd, startIndex);
                startIndex += 64;
            }
            // The final data block. 
            return CryptoHelper.GetHashFinalBlock(
        ...
        */
        ...
        {
            if (null == input) throw new System.ArgumentNullException("input", "Unable convert null array to array of uInts");
