...
{
    [Serializable]
    public class OrganizationUserMemberDataCriteria : Csla.CriteriaBase<OrganizationUserMemberDataCriteria>, IDataCriteria
    {
        ...
        public OrganizationUserMemberDataCriteria()
        {
            this.SortBy = null;
