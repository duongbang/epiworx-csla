...
namespace Epiworx.Business
{
    ...
    {
        private static Csla.PropertyInfo<int> TimelineIdProperty =
            RegisterProperty<int>(row => row.TimelineId, "TimelineId");
        [DataObjectField(true, false)]
        public int TimelineId
        {
            get { return this.GetProperty(TimelineIdProperty); }
            private set { this.SetProperty(TimelineIdProperty, value); }
        }
        ...
        public string CreatedByEmail
        {
            ...
            private set { this.SetProperty(CreatedByEmailProperty, value); }
        }
        ...
        public string ModifiedByEmail
        {
            ...
            private set { this.SetProperty(ModifiedByEmailProperty, value); }
        }
