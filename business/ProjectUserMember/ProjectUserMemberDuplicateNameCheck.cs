...
{
    public class ProjectUserMemberDuplicateNameCheck : BusinessRule
    {
        protected override void Execute(RuleContext context)
        {
            var target = (IProjectUserMember)context.Target;
            ...
            var data = ProjectUserMemberInfoList.FetchProjectUserMemberInfoList(new ProjectUserMemberDataCriteria
                {
