...
{
    public partial class FeedSourceMembers
    {
        ...
        public FeedSourceMember Add(ISource source)
        {
            return this.Add(source.SourceId, source.SourceType);
        }

        public FeedSourceMember Add(int sourceId, SourceType sourceTypeId)
        {
            ...
            var child = FeedSourceMember.NewFeedSourceMember(
